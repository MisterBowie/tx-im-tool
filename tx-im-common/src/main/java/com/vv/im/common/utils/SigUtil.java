package com.vv.im.common.utils;
...
public class SigUtil {
     ...
     */
    public static String genPrivateMapKey(String userid, long expire, long roomid, long privilegeMap,long sdkappid,String key) {
        byte[] userbuf = genUserBuf(userid, roomid, expire, privilegeMap, 0, "",sdkappid);  //生成userbuf
        return genUserSig(userid, expire, userbuf,sdkappid,key);
    }
     ...
     * @return usersig - Generate signature with userbuf
     */
    public String genPrivateMapKeyWithStringRoomID(String userid, long expire, String roomstr, long privilegeMap,long sdkappid,String key) {
        byte[] userbuf = genUserBuf(userid, 0, expire, privilegeMap, 0, roomstr,sdkappid);  //生成userbuf
        return genUserSig(userid, expire, userbuf,sdkappid,key);
    }
    ...
    public static byte[] genUserBuf(String account, long dwAuthID, long dwExpTime,
                             long dwPrivilegeMap, long dwAccountType, String RoomStr,long sdkappid) {
